...
async def edit_or_reply(message, text, parse_mode="md"):
    ...
    if not message:
        return await message.edit(text, parse_mode=enums.ParseMode.DEFAULT)
    ...
    if message.from_user.id:
        if message.reply_to_message:
            ...
            return await message.reply_text(
                text, reply_to_message_id=kk, parse_mode=enums.ParseMode.DEFAULT
            )
        return await message.reply_text(text, parse_mode=enums.ParseMode.DEFAULT)
    return await message.edit(text, parse_mode=enums.ParseMode.DEFAULT)

async def prime_or_reply(message: Message, *args, **kwargs) -> Message:
    apa = (
        message.edit_text
